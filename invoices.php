  ...
  <body>
    ...
    <div class="off-canvas-wrap multilevel-offcanvas" data-offcanvas>
      <div class="inner-wrap">
        ...
        <header id="invoice-header" class="site-header">
          <div class="row">
        ...
        <section id="invoice-section-content" class="site-content clearfix">
          <div class="row">
            ...
            <div class="site-content-block site-content-invoice-step site-content-invoice-step-2 small-12 columns hide">
            ...
            <div>
              ...
              <div class="small-12 large-6 columns">
                <div class="container_map">
                  <div id="invoice-map_container"></div>
                  <div id="invoice-map"></div>
                </div>
              </div>
